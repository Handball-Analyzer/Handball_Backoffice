<script lang="ts">
	...
	const sourceData = [
		{ UUID: 123345, Name: 'VFL Waiblingen', adress:"Beinsteinerstr. 160", halle: "Rundsporthalle"},
		{ UUID: 123346, Name: 'TSV Schmiden', adress:"Fellbacher Straße 45", halle: "Sporthalle am Schulzentrum" },
		{ UUID: 123347, Name: 'TV Oeffingen', adress:"Kellerstraße 45", halle: "Sporthalle"},
		{ UUID: 123347, Name: 'HSC Schmoeff', adress:"Fellbacher Straße 45", halle: "Sporthalle am Schulzentrum"},
		{ UUID: 123347, Name: 'TV Bittenfeld', adress:"Bittenfelderstraße 120", halle: "Ballspielhalle"},
		...
		<div class="w-1/2 h-full m-2">
			<div class="h-full">
				...
				<TabGroup>
					...
					<Tab bind:group={tabSet} name="tab3" value={3}>Abo</Tab>
					<!-- Tab Panels --->
